...
import { button, isDanger, isInfo, isLink, isPrimary, isRounded, isSuccess, isWarning, isLight, isSmall, isNormal, isMedium, isLarge, isOutlined, isInverted } from "../classes";
import classNames from "classnames";
var Button = function (_a) {
    var _b;
    var children = _a.children, light = _a.light, primary = _a.primary, success = _a.success, link = _a.link, info = _a.info, warning = _a.warning, danger = _a.danger, small = _a.small, normal = _a.normal, medium = _a.medium, large = _a.large, rounded = _a.rounded, outlined = _a.outlined, inverted = _a.inverted, li = _a.li, p = _a.p, s = _a.s, l = _a.l, i = _a.i, w = _a.w, d = _a.d, r = _a.r, onClick = _a.onClick;
